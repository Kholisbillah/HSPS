...
-- Generation Time: Apr 01, 2026 at 02:24 AM
...
(1, 'Basement 1 - Motor Umum', 200, 'motor', 2, '2026-03-18 14:19:10', '2026-03-31 13:54:24'),
...
INSERT INTO `transaksi` (`id_parkir`, `id_tarif`, `id_area`, `id_user`, `id_kendaraan`, `plat_nomor`, `jenis_kendaraan`, `waktu_masuk`, `waktu_keluar`, `durasi_jam`, `biaya_total`, `status`, `metode_entry`, `gate_type`, `metode_pembayaran`, `foto_masuk`, `foto_keluar`, `created_at`, `updated_at`) VALUES
(1, 1, 1, 1, NULL, 'B1223H', 'motor', '2026-03-28 14:11:38', '2026-03-28 14:11:55', 1, 2000, 'keluar', 'Manual', NULL, NULL, NULL, NULL, '2026-03-28 07:11:38', '2026-03-28 07:11:55'),
(2, 2, 2, 1, 1, 'B2175TOR', 'mobil', '2026-03-28 14:37:08', '2026-03-28 14:41:49', 1, 0, 'keluar', 'QR', NULL, NULL, NULL, NULL, '2026-03-28 07:37:08', '2026-03-28 07:41:49'),
(3, 2, 3, 1, 1, 'B2175TOR', 'mobil', '2026-03-28 14:42:26', '2026-03-29 13:10:41', 23, 0, 'keluar', 'QR', NULL, NULL, NULL, NULL, '2026-03-28 07:42:26', '2026-03-29 06:10:41'),
(4, 1, 1, 2, 1, 'B2175TOR', 'motor', '2026-03-31 07:01:32', '2026-03-31 19:55:12', 13, 0, 'keluar', 'QR', 'gate_out_1', 'vip', NULL, NULL, '2026-03-31 00:01:32', '2026-03-31 12:55:12'),
(5, 1, 1, 2, 1, 'B2175TOR', 'motor', '2026-03-31 07:02:00', '2026-03-31 07:14:20', 1, 0, 'keluar', 'QR', 'gate_out_1', 'vip', NULL, NULL, '2026-03-31 00:02:00', '2026-03-31 00:14:20'),
(6, 1, 1, 2, NULL, 'GATE-M-31071254', 'motor', '2026-03-31 07:12:54', '2026-03-31 20:31:45', 14, 28000, 'keluar', 'Manual', 'gate_out_1', 'cash', NULL, NULL, '2026-03-31 00:12:54', '2026-03-31 13:31:45'),
(7, 1, 1, 2, NULL, '-', 'motor', '2026-03-31 17:19:02', '2026-03-31 20:31:53', 4, 8000, 'keluar', 'Kamera', 'gate_out_1', 'cash', NULL, NULL, '2026-03-31 10:19:02', '2026-03-31 13:31:53'),
(8, 1, 1, 2, NULL, '-', 'motor', '2026-03-31 17:19:22', '2026-03-31 20:38:04', 4, 8000, 'keluar', 'Kamera', 'gate_out_1', 'cash', NULL, NULL, '2026-03-31 10:19:22', '2026-03-31 13:38:04'),
(9, 1, 1, 2, NULL, '-', 'motor', '2026-03-31 17:25:09', '2026-03-31 20:38:09', 4, 8000, 'keluar', 'Kamera', 'gate_out_1', 'cash', NULL, NULL, '2026-03-31 10:25:09', '2026-03-31 13:38:09'),
(10, 1, 1, 2, NULL, '-', 'motor', '2026-03-31 19:54:01', '2026-03-31 20:38:15', 1, 2000, 'keluar', 'Kamera', 'gate_out_1', 'cash', NULL, NULL, '2026-03-31 12:54:01', '2026-03-31 13:38:15'),
(11, 1, 1, 2, NULL, '-', 'motor', '2026-03-31 20:17:36', '2026-03-31 20:18:22', 1, 2000, 'keluar', 'Kamera', 'gate_out_1', 'cash', NULL, NULL, '2026-03-31 13:17:36', '2026-03-31 13:18:22'),
(12, 1, 1, 2, NULL, '-', 'motor', '2026-03-31 20:50:10', NULL, NULL, 0, 'masuk', 'Kamera', 'gate_in_motor', NULL, NULL, NULL, '2026-03-31 13:50:10', '2026-03-31 13:50:10'),
(13, 1, 1, 2, NULL, '-', 'motor', '2026-03-31 20:54:24', NULL, NULL, 0, 'masuk', 'Kamera', 'gate_in_motor', NULL, NULL, NULL, '2026-03-31 13:54:24', '2026-03-31 13:54:24');
...
--
ALTER TABLE `log_aktivitas`
  MODIFY `id_log` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=68;
...
--
ALTER TABLE `transaksi`
  MODIFY `id_parkir` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
